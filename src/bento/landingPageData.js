...
export const landingPageData = {
  ...
  callToActionDescription: 'A data repository in the Cancer Research Data Commons ($$[CRDC](https://datacommons.cancer.gov/)$$) ecosystem for storing and sharing data generated by NCI funded programs. The CRDC Data Hub Portal provides secure and authorized storage and data sharing capabilities in the cloud for studies that are not a good match for submission to other CRDC repositories. The CRDC Data Hub Portal will host cancer data of all types including genomic, proteomic, and imaging data.',
  callToActionButtonText: 'EXPLORE CRDC DATA HUB PORTAL',
  ...
  tile1: {
    ...
    titleText: 'ABOUT THE CRDC DATA HUB PORTAL',
    descriptionText: 'Cancer Research Data Commons ($$[CRDC](https://datacommons.cancer.gov/)$$) infrastructure for storing cancer research data generated by NCI funded programs. The CRDC Data Hub Portal provides secure and authorized storage and data sharing capabilities in the cloud for all studies.',
  ...
  tile2: {
    ...
    titleText: 'STUDIES',
    descriptionText: 'View summaries of the studies within the Data Hub Portal.',
  ...
  tile4: {
    ...
    titleText: 'CRDC DATA HUB DATA',
    descriptionText: 'Search through all the data in the Data Hub Portal, build cohorts across studies released on the CRDC Data Hub Portal. The data files from these cohorts can be analyzed on the NCI’s Cloud Resources.',
